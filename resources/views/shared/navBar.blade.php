...
<<<<<<< HEAD
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container">
          <a class="navbar-brand logo_h" href="{{ route("home.index") }}"><img src="img/logo.png" alt=""></a>
            ...
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              ...
              <li class="nav-item submenu dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a class="nav-link" href="{{route("products.index")}}">Shop Category</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{route("product.index")}}">Product Details</a></li>
...
>>>>>>> 9436a70542232e97f874a973ea378788fda6b2c3
    </div>
</header>
