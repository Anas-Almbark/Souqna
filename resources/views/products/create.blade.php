            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-6 col-lg-6 col-md-8 col-sm-10 col-12">
                    <div class="card mx-auto">
                        ...
                        <div class="card-body">
                            <form action="{{ route('products.store') }}" id="basicform" method="POST" data-parsley-validate>
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="inputStatus" name="status" data-parsley-equalto="#inputStatus" type="text" required
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="productImages" name="image" class="form-control"
                                        accept="image/*">
                                    <small class="form-text text-muted">
                                        You can select multiple images for your product
                                    </small>
                                </div>
